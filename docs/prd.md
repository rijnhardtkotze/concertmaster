...
- [ ] Two Extractions describe the same Performance when they share date, Venue, time bucket (morning, afternoon or evening) and normalised title. A fuzzy title match above the current threshold is the fallback.
